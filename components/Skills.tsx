              ...
              <div className="relative h-full w-full transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                ...
                <div className="absolute inset-0 h-full w-full border-2 md:border-4 border-black bg-white p-3 md:p-8 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] md:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between [backface-visibility:hidden]">
                  <div className="flex justify-between items-start border-b-2 border-black pb-1 md:pb-2">
                    <span className="text-[8px] md:text-[12px] font-black text-zinc-400 uppercase tracking-widest">
                      {tech.level}
                    </span>
                    <span className="text-[8px] md:text-[12px] font-black text-black">
                      0{index + 1}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 md:space-y-4">
                    <div>
                      <h3 className="text-xs md:text-2xl font-black uppercase tracking-tighter text-black leading-none">
                        {tech.name}
                      </h3>
                      <p className="text-[8px] md:text-[11px] font-bold text-zinc-500 uppercase tracking-widest mt-1">
                        {tech.type}
                      </p>
                    </div>
