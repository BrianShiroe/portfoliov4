...
const techClasses = [
  ...
  { slug: 'css3', name: 'CSS3', type: 'Styling', class: 'Dancer', hp: 98, mp: 95 },
  { slug: 'figma', name: 'UI/UX Design', type: 'Aesthetics', class: 'Bard', hp: 85, mp: 85 },
];

const ExternalIcon = ({ slug }: { slug: string }) => (
  <div 
    className="h-16 w-16 bg-black group-hover:bg-green-500 transition-colors duration-200"
    style={{
...
export function Skills() {
  ...
  return (
    <section className="relative w-full border-t-4 border-black bg-zinc-50 py-24 overflow-hidden selection:bg-black selection:text-white font-sans">
      
      {/* 1. TOP UTILITY BAR (The Extra Detail) */}
      <div className="mx-auto max-w-7xl px-6 mb-12 flex flex-wrap items-center justify-between gap-4 border-b-2 border-black pb-4">
        ...
        <div className="hidden md:flex gap-4">
           <div className="h-4 w-32 bg-zinc-200 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
          <div className="relative">
            <div className="absolute -left-4 -top-4 h-12 w-12 border-l-4 border-t-4 border-black" />
            <p className="text-xs font-black text-zinc-400 uppercase tracking-[0.5em] mb-4 ml-2 italic underline decoration-black underline-offset-4">Capability_Inventory // v4.6</p>
            <h2 className="text-7xl md:text-9xl font-black uppercase tracking-tighter text-black leading-[0.75]">
          ...
          <div className="flex flex-col items-end text-right">
             ...
             <p className="text-sm font-bold border-2 border-black bg-white text-black px-5 py-2 uppercase tracking-widest shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all cursor-wait">
                Verified Skills
             </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {techClasses.map((tech, index) => (
            <motion.div 
              ...
              className="group relative h-[420px] [perspective:1000px] cursor-crosshair"
            >
              <div className="relative h-full w-full transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                
                {/* CARD FRONT */}
                <div className="absolute inset-0 h-full w-full border-4 border-black bg-white p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col justify-between [backface-visibility:hidden]">
                  ...
                  <div className="flex-grow flex items-center justify-center">
                    <div className="relative border-2 border-zinc-50 p-6 group-hover:border-black transition-colors duration-300 group-hover:bg-zinc-50 shadow-sm group-hover:shadow-none">
                  ...
                  <div className="space-y-4">
                     <div>
                        <h3 className="text-2xl font-black uppercase tracking-tighter text-black leading-none mb-1 group-hover:italic transition-all">{tech.name}</h3>
                ...
                {/* CARD BACK */}
                <div className="absolute inset-0 h-full w-full border-4 border-black bg-black p-8 shadow-[8px_8px_0px_0px_rgba(34,197,94,0.3)] text-white [transform:rotateY(180deg)] [backface-visibility:hidden]">
                    <div className="h-full flex flex-col justify-between font-mono">
                      <div className="space-y-4">
                        ...
                        <p className="text-sm uppercase leading-relaxed tracking-tight border-l-2 border-green-500 pl-4 py-1 italic">
                           Mastery in {tech.name} confirmed. Scalable architectures deployed in Dubai_2026.
                        </p>
                        <div className="grid grid-cols-2 gap-2 text-[8px] text-zinc-500 border border-zinc-800 p-2 uppercase">
        ...
        <div className="mt-24 pt-12 border-t-2 border-black/10 flex flex-col md:flex-row items-center justify-between gap-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-700">
