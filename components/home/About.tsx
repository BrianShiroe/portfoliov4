...
export function About() {
      ...
      <div className="mx-auto max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-4 space-y-8">
            {/* Identity Card */}
            <div
              className={`relative border-4 border-black bg-white p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] ${isAr ? "shadow-[-6px_6px_0px_0px_rgba(0,0,0,1)]" : ""}`}
            >
            ...
            {/* ACCOLADES BLOCK */}
            <div
              className={`bg-black text-white p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,0.1)] ${isAr ? "shadow-[-6px_6px_0px_0px_rgba(0,0,0,0.1)]" : ""}`}
            >
  ...
  ${isAr ? "text-4xl md:text-5xl lg:text-6xl leading-[1.2]" : "text-4xl md:text-6xl lg:text-7xl leading-none"}`}
              ...
              <p
                className={`font-bold text-zinc-700 uppercase ${isAr ? "text-base md:text-lg leading-relaxed" : "text-lg md:text-xl leading-relaxed"}`}
              >
                {t(
              ...
              <div
                className={`space-y-6 text-zinc-500 italic ${isAr ? "border-r-4 border-l-0 pr-6 md:pr-8 text-sm md:text-base" : "border-l-4 pr-0 pl-6 md:pl-8 text-base md:text-lg"} border-black font-medium`}
              >
                <p>
                  {t(
              ...
              <div
                className={`mt-12 bg-white border-2 border-black p-6 md:p-8 rounded-2xl font-mono text-sm leading-relaxed shadow-[6px_6px_0px_0px_#00C950] ${isAr ? "shadow-[-6px_6px_0px_0px_#00C950]" : ""}`}
              >
                ...
                <motion.span
                  ...
                  className={`inline-block w-2 h-4 bg-[#00C950] translate-y-1 ${isAr ? "mr-1" : "ml-1"}`}
                />
              </div>
            </motion.div>
          </div>
