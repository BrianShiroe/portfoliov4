      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 md:px-10 flex flex-col items-center justify-center">
        <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-10 lg:gap-16">
          ...
          <div className="relative flex flex-col items-center w-full lg:flex-1">
            <div className="relative w-full max-fit mx-auto text-center">
              ...
              <div className="mb-6 inline-block bg-black px-4 py-1.5 rounded-full text-[9px] md:text-[11px] font-bold font-mono uppercase tracking-[0.2em] text-white">
                {t("Web Developer & Digital Marketing in Dubai", "مطور ويب وتسويق رقمي في دبي")}
              </div>

              <h1 className={`text-center font-black uppercase mb-4 ${isAr ? "text-[12vw] sm:text-6xl md:text-7xl lg:text-8xl leading-[1.1]" : "text-[15vw] sm:text-7xl md:text-8xl lg:text-9xl leading-[0.85] md:leading-[0.8] tracking-tighter"}`}>
                {isAr ? <>برايان <br /> <span className="text-[#00C950]">شيرو</span></> : <>Brian <br /> <span className="text-[#00C950]">Shiroe</span></>}
              </h1>

              <div className="flex items-center justify-center gap-2 md:gap-3 mb-8">
                <div className="h-[1px] w-4 md:w-8 bg-black/20" />
                <span className="text-[10px] md:text-sm font-black uppercase tracking-[0.2em] text-black italic">Brian Ong Haw</span>
                <div className="h-[1px] w-4 md:w-8 bg-black/20" />
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-6 mb-10 w-full">
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 border-y border-black/5 py-5 w-full max-w-[320px] sm:max-w-none justify-center">
                <motion.a whileTap={{ scale: 0.95 }} href="mailto:Brianshiroe@gmail.com" className="flex items-center gap-2 text-[10px] md:text-[12px] font-black uppercase tracking-wider text-zinc-600 hover:text-[#00C950] transition-colors group cursor-pointer">
                ...
                <motion.a whileTap={{ scale: 0.95 }} href="tel:+971503592133" className="flex items-center gap-2 text-[10px] md:text-[12px] font-black uppercase tracking-wider text-zinc-600 hover:text-[#00C950] transition-colors group cursor-pointer">
                  <div className="p-1.5 rounded-lg bg-zinc-50 group-hover:bg-[#00C950]/10 transition-colors">
              ...
              <div className="flex gap-10">
                {['github', 'linkedin'].map((platform) => (
                  <motion.a 
                    key={platform}
                    href={platform === 'github' ? "https://github.com/BrianShiroe" : "https://www.linkedin.com/in/brianshiroe/"}
                    target="_blank"
                  ...
                  >
                    <img src={`https://img.icons8.com/fluency/48/${platform}.png`} alt={platform} className="w-8 h-8 filter grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all" />
                  </motion.a>
                ))}
              </div>
            </div>
          ...
          <div className="flex flex-col items-center relative mt-4 lg:mt-0">
            <motion.div whileTap={{ scale: 0.98 }} className="bg-white border-2 md:border-4 border-black p-3 md:p-6 rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center overflow-hidden cursor-default">
              ...
              <div className="w-full border-t-2 border-black/10 pt-4 mt-2 text-center">
                <span className="text-xl md:text-2xl font-black text-black tabular-nums tracking-wider font-mono">{time}</span>
