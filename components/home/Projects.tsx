...
export function Projects() {
  ...
  const projects = [
    {
      id: "01",
      title: "GameTree",
      tag: t("E-COMMERCE MARKETPLACE", "سوق تجارة إلكترونية"),
      tech: "Next.js / Supabase / Stripe",
      href: "https://gametree.vercel.app/",
      image: "/images/gametree/thumbnail.png",
      description: t(
        "A high-performance gaming marketplace with real-time inventory and global payment integration.",
        "سوق ألعاب عالي الأداء مع مخزون في الوقت الفعلي وتكامل دفع عالمي.",
      ),
    },
    {
      id: "02",
      ...
      description: t(
        "A minimalist jewelry showcase focusing on high-fidelity imagery and smooth micro-interactions.",
        "عرض مجوهرات بسيط يركز على الصور عالية الدقة والتفاعلات الدقيقة السلسة.",
      ),
    },
    {
      id: "03",
      title: "Blackscale",
      tag: t("PROPTECH SOLUTIONS", "حلول العقارات الرقمية"),
      tech: "Next.js / Supabase / UI/UX",
      href: "https://greyscale-real-estate.vercel.app/",
      image: "/images/greyscale-real-estate/thumbnail.png",
      description: t(
        "Modernizing real estate listings with a brutalist aesthetic and robust database architecture.",
        "تحديث قوائم العقارات بجمالية واضحة وبنية قاعدة بيانات قوية.",
      ),
    },
    {
      id: "04",
      ...
      image: null, // Keeps the code-placeholder for this specific item
      description: t(
        "Real-time object detection and AI-driven visual analysis for security infrastructures.",
        "كشف الأشياء في الوقت الفعلي والتحليل البصري المدعوم بالذكاء الاصطناعي للبنى التحتية الأمنية.",
      ),
    },
  ];
  ...
  return (
    <section
      ...
      dir={isAr ? "rtl" : "ltr"}
    >
      {/* Background Subtle Grain/Noise Effect */}
        ...
        <div className="flex flex-col gap-48 md:gap-64">
          {projects.map((work, index) => (
            ...
            >
              ...
              {/* Text Side - Balanced & Clean */}
              <div className={`w-full md:w-[35%] ${index % 2 === 0 ? "text-left" : "md:text-right"} space-y-8`}>
